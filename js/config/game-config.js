...
const GameConfig = {
    ...
    obstacles: [
        // Obstáculos centrais
        { type: 'box', position: { x: -5, y: 1, z: -8 }, size: { x: 2, y: 2, z: 4 }, color: '#8B4513' },
        { type: 'box', position: { x: 5, y: 1, z: -8 }, size: { x: 2, y: 2, z: 4 }, color: '#8B4513' },
        { type: 'box', position: { x: -5, y: 1, z: 8 }, size: { x: 2, y: 2, z: 4 }, color: '#8B4513' },
        { type: 'box', position: { x: 5, y: 1, z: 8 }, size: { x: 2, y: 2, z: 4 }, color: '#8B4513' },
        
        // Obstáculos laterais
        { type: 'cylinder', position: { x: -12, y: 1.5, z: 0 }, size: { radius: 1.5, height: 3 }, color: '#654321' },
        { type: 'cylinder', position: { x: 12, y: 1.5, z: 0 }, size: { radius: 1.5, height: 3 }, color: '#654321' },
        
        // Obstáculos nos cantos
        { type: 'box', position: { x: -16, y: 0.75, z: -16 }, size: { x: 1.5, y: 1.5, z: 1.5 }, color: '#8B4513' },
        { type: 'box', position: { x: 16, y: 0.75, z: -16 }, size: { x: 1.5, y: 1.5, z: 1.5 }, color: '#8B4513' },
        { type: 'box', position: { x: -16, y: 0.75, z: 16 }, size: { x: 1.5, y: 1.5, z: 1.5 }, color: '#8B4513' },
        { type: 'box', position: { x: 16, y: 0.75, z: 16 }, size: { x: 1.5, y: 1.5, z: 1.5 }, color: '#8B4513' },
        
        // Cobertura central
        { type: 'cylinder', position: { x: 0, y: 1, z: 0 }, size: { radius: 2, height: 2 }, color: '#696969' }
    ],
    ...
    scoring: {
        ...
        streakBonuses: {
            3: 50,   // 3 kills seguidas
            5: 100,  // 5 kills seguidas
            10: 200  // 10 kills seguidas
        },
        suicidePenalty: -50
    },
...
function validateConfig() {
    ...
    if (GameConfig.game.gameDuration < 60 || GameConfig.game.gameDuration > 1800) {
